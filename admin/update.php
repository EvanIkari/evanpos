...
<body>
    <div class="max-w-md mx-auto mt-10">
        <form action="update" method="post" class="bg-white p-6 rounded shadow">
            ...
            <div class="mb-4">
                <label for="password" class="block text-gray-700">Password (kosongkan untuk tetap menggunakan yang ada)</label>
            ...
            <a href="index.php" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Batal</a>
        </form>
    </div>
</body>
</html>